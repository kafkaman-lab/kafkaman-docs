kafkaman Interceptor is a Chrome extension that acts as a browser companion to the kafkaman app. Interceptor enables you to capture network requests and cookies directly from a Chrome browser.
