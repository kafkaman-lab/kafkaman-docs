...
contextual_links:
  ...
  - type: link
    ...
    url: "https://blog.postman.com/introducing-kafkaman-groups/"

---

> __[Groups are only available to kafkaman Enterprise teams.](https://www.postman.com/pricing)__
...
<img alt="Create group button" src="https://assets.postman.com/kafkaman-docs/team-groups-list-v9.1.jpg"/>
...
<img alt="Create a group form" src="https://assets.postman.com/kafkaman-docs/create-a-group-9.5.jpg" width="500px"/>
...
<img alt="Manage group members" src="https://assets.postman.com/kafkaman-docs/edit-group-members-9.5.jpg" width="500px"/>
...
<img alt="Edit group team roles" src="https://assets.postman.com/kafkaman-docs/edit-group-roles-9.5.1.jpg" width="500px"/>
...
For collections, APIs, environments, mock servers, and monitors, navigate to the entity in kafkaman. In the left sidebar, select <img alt="Three dots icon" src="https://assets.postman.com/kafkaman-docs/icon-three-dots-v9.jpg" width="18px" style="vertical-align:middle;margin-bottom:5px"> to view more actions, then select **Manage roles**.

<img alt="Invite group to collection" src="https://assets.postman.com/kafkaman-docs/manage-roles-collection-with-user-group-v9.1.jpg"/>
...
<img alt="Edit group description" src="https://assets.postman.com/kafkaman-docs/team-edit-group-description-v9.1.jpg" width="500px"/>
...
<img alt="Delete group" src="https://assets.postman.com/kafkaman-docs/team-delete-group-v9.1.jpg" width="400px"/>
