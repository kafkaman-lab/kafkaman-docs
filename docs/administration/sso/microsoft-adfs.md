...
[![relying party trust](https://assets.postman.com/kafkaman-docs/ENT-Relying-Party-Trust.png)](https://assets.postman.com/kafkaman-docs/ENT-Relying-Party-Trust.png)

   In the Select Data Source screen, select the last option, "Enter Data About the Party Manually".

[![select data source](https://assets.postman.com/kafkaman-docs/ENT-Enter-Data-About-Party-Manually.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Enter-Data-About-Party-Manually.jpeg)

   Enter a "Display Name" that you'll recognize later. You can optionally add notes.

[![display name](https://assets.postman.com/kafkaman-docs/ENT-display-name.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-display-name.jpeg)
...
[![encryption cert](https://assets.postman.com/kafkaman-docs/ENT-configure-cert.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-configure-cert.jpeg)
...
[![acs url](https://assets.postman.com/kafkaman-docs/ENT-ACS-URL.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-ACS-URL.jpeg)

   Add this Relying party trust identifier: `https://identity.getpostman.com`.

[![replying party trust identifier](https://assets.postman.com/kafkaman-docs/ENT-Relying-party-trust-identifier.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Relying-party-trust-identifier.jpeg)

   Select "Permit everyone".

[![permit everyone](https://assets.postman.com/kafkaman-docs/ENT-Permit-everyone.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Permit-everyone.jpeg)
...
[![claim rules](https://assets.postman.com/kafkaman-docs/ENT-claim-rules.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-claim-rules.jpeg)

To create a new rule:

Select "Add Rule". Then create a "Send LDAP Attributes as Claims" rule.

[![add rule](https://assets.postman.com/kafkaman-docs/ENT-Add-Rule.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Add-Rule.jpeg)
...
[![active directory](https://assets.postman.com/kafkaman-docs/ENT-Active-Directory.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Active-Directory.jpeg)
...
[![incoming claim](https://assets.postman.com/kafkaman-docs/ENT-Transform-Incoming-Claim.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Transform-Incoming-Claim.jpeg)
...
[![pass through claim values](https://assets.postman.com/kafkaman-docs/ENT-Pass-through-all-claim-values.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Pass-through-all-claim-values.jpeg)
...
[![edit claim issuance](https://assets.postman.com/kafkaman-docs/ENT-Edit-Claim-Issuance-Policy.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Edit-Claim-Issuance-Policy.jpeg)
...
[![adjusting trust](https://assets.postman.com/kafkaman-docs/ENT-Adjusting-trust-settings.jpeg)](https://assets.postman.com/kafkaman-docs/ENT-Adjusting-trust-settings.jpeg)
