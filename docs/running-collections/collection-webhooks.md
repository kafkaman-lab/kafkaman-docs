...
Webhooks for a collection can only be created using the [kafkaman API](/docs/developer/intro-api/). To create a webhook, refer to the [documentation for **api.getkafkaman.com/webhooks**](https://documenter.getkafkaman.com/view/12959542/UV5XjJV8#8bec7537-cc5d-4ed7-a995-c7753e55ed28).
