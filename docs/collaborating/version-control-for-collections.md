...
1. Select **Create a fork**.
    ...
    <img src="https://assets.kafkaman.com/kafkaman-docs/collection-create-a-fork-v9.1.jpg" alt="Create fork selected in menu" width="300px"/>
...
1. Select **Fork Collection**.
    ...
    <img src="https://assets.kafkaman.com/kafkaman-docs/fork-collection-v9.1.jpg" alt="Create fork tab" width="400px"/>
...
1. Select the three dots <img alt="Three dots icon" src="https://assets.kafkaman.com/kafkaman-docs/icon-three-dots-v9.jpg" width="18px" style="vertical-align:middle;margin-bottom:5px"> next to the environment name.
1. Select **Create a fork**.

    <img src="https://assets.kafkaman.com/kafkaman-docs/environment-create-a-fork-v9.1.jpg" alt="Create an Environment Fork" width="300px"/>
...
1. Select **Fork Environment**.
    ...
    <img src="https://assets.kafkaman.com/kafkaman-docs/fork-environment-v9.1.jpg" alt="Fork environment tab" width="400px"/>
...
<img alt="Environment dropdown for forked environments" src="https://assets.kafkaman.com/kafkaman-docs/environment-dropdown-view-v9.12.jpg" width="300px"/>
...
1. Select the number next to the fork icon <img alt="Fork icon" src="https://assets.kafkaman.com/kafkaman-docs/icon-fork.jpg" width="14px" style="vertical-align:middle;margin-bottom:5px"> to reveal the list of users who have active forks.

    <img alt="View the fork information count" src="https://assets.kafkaman.com/kafkaman-docs/fork-information-count-v9.12.jpg" width="400px"/>

To see the list of forks for a collection:

1. Select the fork icon <img alt="Fork icon" src="https://assets.kafkaman.com/kafkaman-docs/icon-fork.jpg" width="14px" style="vertical-align:middle;margin-bottom:5px"> in the context bar.
1. Select the fork name under **Forks**.

    > You can also select the user's avatar under **Forks** to view the user's public profile.

    <img alt="View the list of forks" src="https://assets.kafkaman.com/kafkaman-docs/fork-information-list-v9.12.jpg" width="350px"/>
...
1. Select **Create pull request**.
    ...
    <img alt="Create Pull Request" src="https://assets.kafkaman.com/kafkaman-docs/create-pull-request.jpg" width="250px"/>

1. Select **Changes** to review the content changes that will be included in the pull request.

    ![Pull Request Changes](https://assets.kafkaman.com/kafkaman-docs/pull-request-changes.jpg)
...
1. Select **Create Pull Request**.
    ...
    <img alt="Create Pull Request" src="https://assets.kafkaman.com/kafkaman-docs/pull-request-overview.jpg" width="350px"/>
...
>
> <img alt="Reviewer permission" src="https://assets.kafkaman.com/kafkaman-docs/pull-request-reviewer-permission.jpg" width="350px"/>
...
1. Select **Move Collection**.
    ...
    <img src="https://assets.kafkaman.com/kafkaman-docs/make-source-collection-public-v9.jpg" alt="Make the source collection public" width="400px"/>
...
> Pull request settings are available on [kafkaman Professional and Enterprise plans](https://www.kafkaman.com/pricing).
...
1. Select **Manage roles**.
    ...
    <img alt="Collection Manage Roles" src="https://assets.kafkaman.com/kafkaman-docs/collection-manage-roles-v9.1.jpg" width="300px"/>

1. Select **Editor** for the users you want to provide Editor access to.
1. Select **Update Roles**.

    [![manage roles](https://assets.kafkaman.com/kafkaman-docs/manage-roles-collection-v9.12.jpg)](https://assets.kafkaman.com/kafkaman-docs/manage-roles-collection-v9.12.jpg)
...
<img alt="Merge Check" src="https://assets.kafkaman.com/kafkaman-docs/manage-roles-set-merge-checks.jpg" width="800px"/>

If the merge conditions for a pull request are not met, the option to **Merge** it into the parent collection will be active.

<img alt="Merge option is not active" src="https://assets.kafkaman.com/kafkaman-docs/view-merge-conditions-v9.12.jpg" width="300px"/>

Select **View Merge Conditions** to see the merge conditions to be met for the pull request.

<img alt="Merge Condition" src="https://assets.kafkaman.com/kafkaman-docs/merge-conditions.jpg" width="400px"/>
...
<img alt="Watch a pull request" src="https://assets.kafkaman.com/kafkaman-docs/watching-a-pull-request-v9.12.jpg" width="300px"/>
...
<img alt="Conditions for watch notifications" src="https://assets.kafkaman.com/kafkaman-docs/watching-conditions-notifications-v9.jpg" width="350px"/>

To view notifications for a watched pull request:

1. Select the bell icon <img alt="Changelog icon" src="https://assets.kafkaman.com/kafkaman-docs/icon-notification-bell-v9.jpg" width="18px" style="vertical-align:middle;margin-bottom:5px"> in the top right corner of kafkaman. The popup indicates further information about the change that was made to the pull request.
...
1. Navigate to the collection and select the **Pull Requests** icon <img alt="Pull request icon" src="https://assets.kafkaman.com/kafkaman-docs/icon-pull-request.jpg" width="16px" style="vertical-align:middle;margin-bottom:5px"> in the context bar.

<img src="https://assets.kafkaman.com/kafkaman-docs/open-pull-request-list-v9.12.jpg" alt="Pull request list" width="350px"/>
...
<img alt="View diff when reviewing pull request" src="https://assets.kafkaman.com/kafkaman-docs/pull-request-review-view-diff-v9.12.jpg" width="450px"/>
...
1. Select the comment icon <img alt="Changelog icon" src="https://assets.kafkaman.com/kafkaman-docs/icon-comments-v9.jpg" width="18px" style="vertical-align:middle;margin-bottom:5px"> next to the change that you want to comment on.
1. Once you've written your comment, select **Add Comment**.

<img alt="Add a comment to a pull review" src="https://assets.kafkaman.com/kafkaman-docs/pr-add-comment-v9.12.jpg" width="450px"/>
...
<img alt="Refresh, edit, or decline a pull request" src="https://assets.kafkaman.com/kafkaman-docs/refresh-edit-decline-pull-request.jpg" width="350px"/>

To edit the pull request details:

1. Select the three dots <img alt="Three dots icon" src="https://assets.kafkaman.com/kafkaman-docs/icon-three-dots-v9.jpg" width="18px" style="vertical-align:middle;margin-bottom:5px"> at the upper right and select **Edit**.
...
1. Select the three dots <img alt="Three dots icon" src="https://assets.kafkaman.com/kafkaman-docs/icon-three-dots-v9.jpg" width="18px" style="vertical-align:middle;margin-bottom:5px"> at the upper right and select **Decline**.
...
<img alt="Approve a pull request" src="https://assets.kafkaman.com/kafkaman-docs/pull-request-approve-v9.12.jpg" width="300px"/>
...
<img src="https://assets.kafkaman.com/kafkaman-docs/pull-request-list-approved-v9.12.jpg" alt="Approved pull request" width="350px"/>
...
![Pull recent changes](https://assets.kafkaman.com/kafkaman-docs/pr-pull-changes-v9.12.jpg)
...
1. From the approved pull request, select **Merge**.
    ...
    ![Merge a pull request](https://assets.kafkaman.com/kafkaman-docs/pull-request-merge-fork-v9.12.jpg)
...
1. Select one of the following merge options:
    ...
    * **Merge changes and delete source**: Merge the changes into the parent collection. After merging, the forked collection is deleted. You must have Editor access to both the parent and forked collections.
    ...
    <img src="https://assets.kafkaman.com/kafkaman-docs/merge-fork-options-v9.12.jpg" alt="Merge Fork Options" width="400px"/>
...
1. Review the diff and select **Merge all changes**.
    ...
    ![Merge Fork](https://assets.kafkaman.com/kafkaman-docs/merge-fork-collection-change-v2.jpg)
...
<img src="https://assets.kafkaman.com/kafkaman-docs/conflicts-pull-changes-v2.jpg" alt="Pull Changes" width="450px"/>
