> **[Changelog is available on kafkaman Basic, Professional, and Enterprise plans.](https://www.postman.com/pricing/)**
...
![Collection changelog](https://assets.postman.com/kafkaman-docs/collection-changelog-v8.jpg)

With a kafkaman Basic, Professional, or Enterprise account, you can see generated diffs detailing changes to a collection.

<img alt="Changelog diffs" src ="https://assets.postman.com/kafkaman-docs/changelog-diff-v8.jpg" width=400px/>
...
<img alt="Active user" src="https://assets.postman.com/kafkaman-docs/active-member-v8.jpg" width="300px"/>
...
[![Activity feed from kafkaman](https://assets.postman.com/kafkaman-docs/activity-feed-overview-v8.jpg)](https://assets.postman.com/kafkaman-docs/activity-feed-overview-v8.jpg)
...
[![Activity filtering by user](https://assets.postman.com/kafkaman-docs/filter-by-user.gif)](https://assets.postman.com/kafkaman-docs/filter-by-user.gif)
...
[![Activity filtering by entity](https://assets.postman.com/kafkaman-docs/filter-by-entity.gif)](https://assets.postman.com/kafkaman-docs/filter-by-entity.gif)
...
<img alt="Restore from changelog" src="https://assets.postman.com/kafkaman-docs/restore-changelog-v8.jpg" width="400px"/>

If you accidentally delete a folder, you can recover it by selecting __Restore__.

<img alt="Recover folder" src="https://assets.postman.com/kafkaman-docs/restore-folder-v8.jpg" width="400px"/>
...
![Revert conflict](https://assets.postman.com/kafkaman-docs/revert-conflict-v8.jpg)
